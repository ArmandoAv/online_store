...
def create_sequence():
    try:
        ...
        conn.commit()
        print("orderdet_id_seq successfully created in Oracle.")
...
def drop_sequence():
    try:
        ...
        conn.commit()
        print("orderdet_id_seq sequence successfully droped in Oracle.")
        ...
        for ord in range(max_order_ids):
            ...
            for det in range(num_details):
                ...
                cursor.execute("""
                    ...
                    VALUES (orderdet_id_seq.NEXTVAL, :1, :2, :3, :4)
